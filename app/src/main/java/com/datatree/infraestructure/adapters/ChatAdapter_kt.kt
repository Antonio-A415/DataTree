...
import com.datatree.infraestructure.dataclass.Message

class ChatAdapter_kt (private val messages: List<Message>): RecyclerView.Adapter<ChatAdapter_kt.ChatViewHolder>(){
