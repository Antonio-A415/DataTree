package com.datatree.core.webrtc
...
class WebRTCClient @Inject constructor(
    ...
    //Este bloque define una lista de con un ICE Server (Interactive Connectivity Establishment), que en este
    //caso es un servidor turn seguro sobre TLS, escuchando el puerto 443 con protocolo TCP.

    //El patrón STUN+TURN es el recomendado
    private val iceServer = listOf(
        ...
        PeerConnection.IceServer.builder("turn:global.relay.metered.ca:80")
            .setUsername("5bb8a6aae500c76e639729b6")
            .setPassword("koHDlfmeIKcuA10G")
            .createIceServer(),
    ...
    fun enableSpeakerphone(enable: Boolean) {
        ...
        // Primero abandonamos el enfoque de audio si lo teníamos
        ...
        // Activamos o desactivamos el altavoz según corresponda
    ...
    private fun createScreenCapturer():VideoCapturer {
        return ScreenCapturerAndroid(permissionIntent, object : MediaProjection.Callback() {
            override fun onStop() {
                super.onStop()
                Log.d("Permisos: ", "onStop: permission of screen casting is stopped")
            }
        })
    }
