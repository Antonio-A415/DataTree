...
import com.datatree.databinding.ActivityCallBinding
import com.datatree.core.services.MainService
import com.datatree.core.services.MainServiceRepository
import com.datatree.core.utils.convertToHumanTime
import com.datatree.core.webrtc.RTCAudioManager
...
class CallActivity : AppCompatActivity(), MainService.EndCallListener {
    ...
    private fun init(){
        ...
        views.apply {
            callTitleTv.text = "En llamada con $target"
