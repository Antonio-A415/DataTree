...
import com.datatree.databinding.ListaUsuariosBinding
...
@AndroidEntryPoint
class ListaUsuarios : AppCompatActivity(), MainRecyclerViewAdapter.Listener, MainService.Listener {
    private val TAG = "ListaUsuarios"

    private lateinit var views: ListaUsuariosBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        views = ListaUsuariosBinding.inflate(layoutInflater)
            ...
            views.apply {
                ...
                acceptButton.setOnClickListener {
                    getCameraAndMicPermission {
                        ...
                        startActivity(Intent(this@ListaUsuarios,CallActivity::class.java).apply {
